...
When user select "Pollution Liability" as Insurance Class
...
When user select "Tanzanian Shillings" as Currency(Excess)
...
When user select "Tanzanian Shillings" as Currency(Inclusions)
...
When user select "Tanzanian Shillings" as Currency(Exclusions)
...
When user select "Tanzanian Shillings" as Currency(Extensions)
...
When user select "Tanzanian Shillings" as Currency(Terms & Conditions)
