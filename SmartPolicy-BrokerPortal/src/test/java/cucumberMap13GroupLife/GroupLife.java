...
public class GroupLife {
	...
	@When("user click on select icon to edit details")
	 ...
	 {
		 Object[] input7=new Object[1];
			input7[0]="//*[@id='sort_table_Credit']/tbody/tr[1]/td[8]/*[1]";
			 Hashtable<String,Object> output=SeleniumOperations.clickOnElement(input7);
	...
	public void user_select_as_insurance_class(String insuranceClass) throws InterruptedException {
	    Itl.CustomDropdownEvent("//*[contains(@aria-controls,'MainContent_cmbInsuranceClass')]", "(//*[@class='select2-search__field'])[2]", insuranceClass , "//*[contains(@id,'select2-MainContent_cmbInsuranceClass-result-')]", "user select {String} as insurance class", "DROPDOWN", 3000);
