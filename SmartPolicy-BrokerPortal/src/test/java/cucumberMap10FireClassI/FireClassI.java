...
public class FireClassI {
	...
	public void user_select_as_insuranceClass(String insuranceClass) {
	    Itl.CustomDropdownEvent("//*[contains(@aria-controls,'MainContent_cmbInsuranceClass')]", "//*[@class='select2-search__field']", insuranceClass , "(//*[contains(@id,'select2-MainContent_cmbInsuranceClass-result-')])[1]", "user select {String} as insurance class", "DROPDOWN", 2000);
