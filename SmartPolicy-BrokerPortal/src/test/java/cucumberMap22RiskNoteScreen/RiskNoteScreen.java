package cucumberMap22RiskNoteScreen;
...
public class RiskNoteScreen {
   ...
   @Then ("^user click on accept button$")
	...
	@When("user clicks on print risk note option")
	public void user_clicks_on_print_quotation_option() throws InterruptedException {
	    Itl.CustomClickEvent("//*[@id='sort_table']/tbody/tr[1]/td[10]/*[5]", "user clicks on print quotation option", "CLICK", 4000);

	}
	@When("the risk note should include all relevant details like")
