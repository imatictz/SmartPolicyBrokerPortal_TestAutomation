package cucumberMap4FireAndBurglary;
...
public class FireAndBurglary 
{
	...
	public void user_navigate_on_operation_dropdown_menu1() throws InterruptedException {
		...
		public void enterSumInsured(String sumInsured) throws Throwable 
		{
		   ...
		   input[1]=sumInsured;
		   Hashtable<String,Object> output= SeleniumOperations.clearAndEnter(input);
		   HTMLReportGenerator.StepDetails(output.get("STATUS").toString(),"user enter \"200000\" as sum insured",output.get("MESSAGE").toString());
		}
		...
		public void enterDescription(String description) throws Throwable 
		{
		    ...
		    input[1]=description;
		    Hashtable<String,Object> output= SeleniumOperations.clearAndEnter(input);
		    HTMLReportGenerator.StepDetails(output.get("STATUS").toString(),"user enter \"Fire & Burglary Quotation Testing\" as description",output.get("MESSAGE").toString());
		}
		...
		public void enterSumInsuredAddOn(String sumInsuredAddOn) throws Throwable 
		{
		   ...
		   Hashtable<String,Object> output= SeleniumOperations.sendKeys(input);
		   HTMLReportGenerator.StepDetails(output.get("STATUS").toString(),"user enter \"150000\" as sum insured (AddOn)",output.get("MESSAGE").toString());
		   Thread.sleep(2000);
		}
		...
		public void enterDescriptionAddon(String description) throws Throwable 
		{
			...
			input[1]=description;
			Hashtable<String,Object> output= SeleniumOperations.sendKeys(input); 
			HTMLReportGenerator.StepDetails(output.get("STATUS").toString(),"user enter \"Fire & Burglary Quotation AddOn\" as description (AddOn)",output.get("MESSAGE").toString());
			Thread.sleep(2000);
		}
