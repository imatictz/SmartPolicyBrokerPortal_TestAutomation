...
public class Fidelity 
{
	...
	public void user_navigate_on_operation_dropdown_menu1() throws InterruptedException {
		...
		@When("user click on select icon to edit details")
		 ...
		 {
			 Object[] input7=new Object[1];
				input7[0]="//*[@id='sort_table_Fedelity']/tbody/tr[1]/td[7]";
				 Hashtable<String,Object> output=SeleniumOperations.clickOnElement(input7);
		...
		public void enterSumInsured(String sumInsured) throws Throwable 
		{
		   ...
		   input[1]=sumInsured;
		   Hashtable<String,Object> output= SeleniumOperations.clearAndEnter(input);
		   HTMLReportGenerator.StepDetails(output.get("STATUS").toString(),"user enter \"4500000\" as sum insured",output.get("MESSAGE").toString());
		}

		@When("^user enter \"([^\"]*)\" as No of employees$")
		public void enterNoofEmployees(String NoOfEmployees) throws Throwable 
		{
			Object[] input=new Object[2];
			   input[0]="//*[@id='txtNoofEmp']";
			   input[1]=NoOfEmployees;
			   Hashtable<String,Object> output= SeleniumOperations.clearAndEnter(input);
			   HTMLReportGenerator.StepDetails(output.get("STATUS").toString(),"user enter \"11\" as No of employees",output.get("MESSAGE").toString()); 
		}
		...
		public void enterDescription(String description) throws Throwable 
		{
		    ...
		    HTMLReportGenerator.StepDetails(output.get("STATUS").toString(),"user enter \"Fidelity Quotation Testing\" as description",output.get("MESSAGE").toString());
		Thread.sleep(2000);
		}
		...
		public void enterDescriptionAddon(String description) throws Throwable 
		{
			...
			input[1]=description;
			Hashtable<String,Object> output= SeleniumOperations.sendKeys(input); 
			   HTMLReportGenerator.StepDetails(output.get("STATUS").toString(),"user enter \"Fidelity Quotation AddOn\" as description (AddOn)",output.get("MESSAGE").toString());
			   Thread.sleep(2000);
		}
