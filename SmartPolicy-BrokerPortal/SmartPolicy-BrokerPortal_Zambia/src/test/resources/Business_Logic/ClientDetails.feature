...
When user enter "House No.12 XYZ World" as address
When user enter "955123456" as mobile No One
When user enter "955123456" as mobile No Two
When user enter "955123456" as mobile No Three
...
When user enter "955123456" as mobile No One
    ...
    When the user enters the mobile number "+255955123456" in mobile number field
    And clicks on the search button
    Then the system should display client(s) whose mobile number is "+255955123456"
    ...
    #Search client
    When the user enters the client name "TestAutomation204" in Name field
    And clicks on the search button
