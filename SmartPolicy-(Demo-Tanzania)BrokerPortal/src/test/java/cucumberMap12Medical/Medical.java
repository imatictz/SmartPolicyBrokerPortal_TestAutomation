...
public class Medical {
	...
	public void user_enter_as_ID_type(String idType) throws Throwable {
	    Itl.CustomDropdownEvent("//*[@id='s2id_MainContent_cmbaIDType']", "//*[@class='select2-input select2-focused']", idType , "//*[@class='select2-match']", "user select \\\"([^\\\"]*)\\\" as ID type", "DROPDOWN", 3000);
