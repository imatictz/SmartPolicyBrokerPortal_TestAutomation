...
public class FireClassI {
	...
	public void clickOnInsuranceClassDropdown() throws Throwable {
		...
		input1[0]="(//*[@class='select2-chosen'])[14]";
	...
	public void enterInsuranceClass(String insuranceClass) throws Throwable {
		...
		Hashtable<String,Object> output= SeleniumOperations.sendKeys(input);
		HTMLReportGenerator.StepDetails(output.get("STATUS").toString(),"user enter \"Industrial/Manufacturing risks-Electronic software parks\" as insurance class",output.get("MESSAGE").toString());
		Thread.sleep(2000);
	}
	...
	public void selectInsuranceClass() throws Throwable {
		...
		input[0]="//*[@class='select2-match']";
		Hashtable<String,Object> output= SeleniumOperations.clickOnElement(input);
		HTMLReportGenerator.StepDetails(output.get("STATUS").toString(),"user select Industrial/Manufacturing risks-Electronic software parks as insurance class",output.get("MESSAGE").toString());
		Thread.sleep(2000);
	}
