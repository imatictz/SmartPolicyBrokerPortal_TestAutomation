@All
Feature: Fire & Burglary Quotation
...
When user enter "Fire" to search insurance type in search box
...
When user enter "150000" as sum insured (AddOn)
When user enter "5" as rate%
